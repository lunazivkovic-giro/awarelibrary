...
public class TreeModel extends PMMLClassifier implements Drawable {
  ...
  static class True extends Predicate {
    ...
    @Override public Eval evaluate(double[] input) {
      return Eval.TRUE;
    }
  ...
  static class SimplePredicate extends Predicate {
    ...
    enum Operator {
      EQUAL("equal") {
        @Override Eval evaluate(double[] input, double value, int fieldIndex) {
  ...
  static class CompoundPredicate extends Predicate {
    ...
    enum BooleanOperator {
      OR("or") {
        @Override Eval evaluate(ArrayList<Predicate> constituents, double[] input) {
  ...
  static class SimpleSetPredicate extends Predicate {
    ...
    enum BooleanOperator {
      IS_IN("isIn") {
        @Override Eval evaluate(double[] input, int fieldIndex, Array set,
      ...
      abstract Eval evaluate(double[] input, int fieldIndex, Array set,
          Attribute nominalLookup);
