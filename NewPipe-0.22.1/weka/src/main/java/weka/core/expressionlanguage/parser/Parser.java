...
@SuppressWarnings({ "rawtypes" }) public class Parser extends java_cup.runtime.lr_parser {
  ...
  public Symbol do_action(int act_num, java_cup.runtime.lr_parser parser,
      java.util.Stack stack, int top) throws Exception {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked", "unused" }) class CUP$Parser$actions {
    ...
    public final Symbol CUP$Parser$do_action(int CUP$Parser$act_num,
        ...
        int CUP$Parser$top) throws Exception {
    ...
    public final Symbol CUP$Parser$do_action_part00000000(int CUP$Parser$act_num,
        java_cup.runtime.lr_parser CUP$Parser$parser, java.util.Stack CUP$Parser$stack,
        int CUP$Parser$top) throws Exception {
      ...
      switch (CUP$Parser$act_num) {
        ...
        {
          Object RESULT = null;
          Node start_val = (Node) ((Symbol) CUP$Parser$stack.elementAt(
        ...
        case 2: // paramlist ::= paramlist COMMA expr
        {
          ...
          List<Node> l = (List<Node>) ((Symbol) CUP$Parser$stack.elementAt(
        ...
        {
          Node RESULT = null;
          Node e = (Node) ((Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 1)).value;
        ...
        {
          Node RESULT = null;
          String m = (String) ((Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 3)).value;
          List<Node> p = (List<Node>) ((Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 1)).value;
        ...
        {
          Node RESULT = null;
          Node l = (Node) ((Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 2)).value;
