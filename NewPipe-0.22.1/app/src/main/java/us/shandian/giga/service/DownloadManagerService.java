...
import com.example.quickvideoplayer.Activity_Videos;
...
public class DownloadManagerService extends Service {
    ...
    public void onCreate() {
        ...
        /** Opening Player module which displays all downloaded videos in device */
        final Intent intent = new Intent(getApplicationContext(), Activity_Videos.class);
