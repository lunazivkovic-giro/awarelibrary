...
public class MissionAdapter extends Adapter<ViewHolder> implements Handler.Callback {
    ...
    private void viewWithFileProvider(Mission mission) {
        ...
        System.out.println("Usla sam u video");
        ...
        //intent.setAction("org.schabi.newpipe.player.VideoPlayer.RESOLUTION_CHANGE");
        intent.putExtra("resolution", "144p");
